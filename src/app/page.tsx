  ...
  return (
    <div className="bg-white">
      ...
      <main>
        ...
        {/* Welcome */}
        <div className="mx-auto flex max-w-7xl flex-col items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-12">
              ...
              <p className="mt-6">
                Welcome to MediCare, where we believe that quality healthcare
                should be accessible to everyone regardless of location. Our
                mission is to revolutionize healthcare experience by leveraging
                accessible and high quality medical care to bringing medical
              ...
              <p className="mt-6">
                At MediCare, we are a team of dedicated healthcare professionals
                that provides exceptional remote healthcare services. our divers
                team includes experience doctors, skilled nurses, and
                pharmacists who are passionate about making healthcare
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-7xl lg:mx-0">
            ...
            <p className="mt-6 text-xl leading-8 text-black">
              Choosing MEDICARE means opting for a healthcare provider that
              prioritizes your health, convenience and overall well-being.
              Experience the future of healthcare today with MEDICARE, your
              trusted partner in remote healthcare.
            </p>
            <p className="mt-6 text-xl leading-8 text-black">
              At MEDICARE, we understand that choosing the right healthcare
